 ...
 *
 * The followings are the available columns in table 'vista_usuarios':
 * @property string $PERNombres
 * @property string $PERApellidos
 * @property string $PERRut
 * @property string $ESTADOnombre
 */
class VistaUsuarios extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('PERNombres, PERApellidos, PERRut', 'required'),
			array('PERNombres, PERApellidos', 'length', 'max'=>25),
			array('PERRut', 'length', 'max'=>12),
			array('ESTADOnombre', 'length', 'max'=>30),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('PERNombres, PERApellidos, PERRut, ESTADOnombre', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('ESTADOnombre',$this->ESTADOnombre,true);
	 ...
	 * @return VistaUsuarios the static model class
	 */
